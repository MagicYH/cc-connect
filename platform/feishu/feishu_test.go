...
func TestBuildReplyContent_FallbackWhenManyTables(t *testing.T) {
	...
	msgType5, _ := buildReplyContent(content5, true)
...
func TestExtractInteractiveCardText(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "argos_alarm_card_top_level_fields",
			content: `{"title":"🚨【报警通知】[L0-P0]Alarm","elements":[[{"tag":"img","image_key":"img_v3_02135"},{"tag":"text","text":"请升级至最新版本客户端，以查看内容"}]],"user_dsl":"{\"schema\":\"2.0\",\"header\":{\"title\":{\"content\":\"🚨【报警通知】[L0-P0]Alarm\",\"tag\":\"plain_text\"},\"subtitle\":{\"content\":\"地区: ASIA-CIS | Argos 报警\",\"tag\":\"plain_text\"}},\"body\":{\"elements\":[{\"tag\":\"column_set\",\"columns\":[{\"tag\":\"column\",\"elements\":[{\"tag\":\"markdown\",\"content\":\"**[PSM]**: my.service.psm\\n**[集群]**: Asia-CIS:default\"}]}]},{\"tag\":\"column_set\",\"columns\":[{\"tag\":\"column\",\"elements\":[{\"tag\":\"markdown\",\"content\":\"**报警上下文**\"},{\"tag\":\"collapsible_panel\",\"header\":{\"title\":{\"content\":\"**Tags**\",\"tag\":\"markdown\"}},\"elements\":[{\"tag\":\"markdown\",\"content\":\"- cluster: default\"}]},{\"tag\":\"button\",\"text\":{\"content\":\"查看详情\",\"tag\":\"plain_text\"},\"url\":\"https://example.com/alarm\"}]}]},{\"tag\":\"hr\"},{\"tag\":\"column_set\",\"columns\":[{\"tag\":\"column\",\"elements\":[{\"tag\":\"button\",\"text\":{\"content\":\"原始报警\",\"tag\":\"plain_text\"},\"url\":\"https://example.com/raw\"}]}]}]}}"}`,
			want:    "🚨【报警通知】[L0-P0]Alarm\n地区: ASIA-CIS | Argos 报警\n**[PSM]**: my.service.psm\n**[集群]**: Asia-CIS:default\n**报警上下文**\n**Tags**\n- cluster: default\n[查看详情](https://example.com/alarm)\n---\n[原始报警](https://example.com/raw)",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
