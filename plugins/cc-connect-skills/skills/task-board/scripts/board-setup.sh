...
PF='[{"field_name":"主任务名","type":"text"},{"field_name":"项目状态","type":"select","options":[{"name":"初始化中"},{"name":"进行中"},{"name":"已完成"},{"name":"已归档"},{"name":"初始化失败"}]},{"field_name":"群chatID","type":"text"},{"field_name":"需求描述","type":"text"},{"field_name":"参与角色","type":"text"},{"field_name":"发起人","type":"text"},{"field_name":"创建时间","type":"created_at"},{"field_name":"完成时间","type":"datetime"}]'
...
TF='[{"field_name":"子任务","type":"text"},{"field_name":"主任务","type":"text"},{"field_name":"群chatID","type":"text"},{"field_name":"角色","type":"select","options":[{"name":"team-leader"},{"name":"developer"},{"name":"tester"},{"name":"reviewer"}]},{"field_name":"状态","type":"select","options":[{"name":"待办"},{"name":"进行中"},{"name":"完成"},{"name":"阻塞"}]},{"field_name":"认领人","type":"text"},{"field_name":"认领令牌","type":"text"},{"field_name":"认领时间","type":"datetime"},{"field_name":"心跳时间","type":"datetime"},{"field_name":"来源任务","type":"text"},{"field_name":"创建人","type":"text"},{"field_name":"产出备注","type":"text"},{"field_name":"创建时间","type":"created_at"},{"field_name":"完成时间","type":"datetime"}]'
